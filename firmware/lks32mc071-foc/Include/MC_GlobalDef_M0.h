...
/* ----------------------VF 启动是否是能------------------------------------------------------------------- */
#define VF_START_STATUS_M0					(TRUE)			// VF 启动状态 TRUE 为使能, FALSE 为不使能, 
															// 当前未用，预留
...
/* ----------------------预充电是否是能--------------------------------------------------------------------- */
#define CHARGE_STATUS_M0					(TRUE)			// CHARGE对相状态 TRUE 为使能, FALSE 为不使能
...
/*------------------------------------弱磁控制---------------------------------------------------------------*/
#define WEAKEN_FLUX_STATUS_M0				(TRUE)			// 弱磁控制状态，TRUE = 使能，FALSE = 不使能
