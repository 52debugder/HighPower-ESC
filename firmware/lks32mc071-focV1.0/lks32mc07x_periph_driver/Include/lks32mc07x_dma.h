...
#define DMA_REQ_TIMER3   BIT7  /*  TIMER4    触发*/
#define DMA_REQ_TIMER2   BIT6  /*  TIMER3    触发*/
#define DMA_REQ_TIMER1   BIT5  /*  TIMER2    触发*/
#define DMA_REQ_TIMER0   BIT4  /*  TIMER1    触发*/
#define DMA_REQ_DSP0     BIT3  /*  DSP0      触发*/
