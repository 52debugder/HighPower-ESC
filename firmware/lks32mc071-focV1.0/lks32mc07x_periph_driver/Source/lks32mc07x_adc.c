...
void ADC_Init(ADC_TypeDef *ADCx, ADC_InitTypeDef *this)
{
    ...
    ADCx->CHNT = (this->IS1 << 8) | (this->S2 << 4) | (this->S1 << 0);
    ADCx->CFG  = (this->NSMP << 12) | (this->DATA_ALIGN << 10) | (this->CSMP << 8) | (this->TCNT << 4) | (this->TROVS << 3) | (this->OVSR << 0);
